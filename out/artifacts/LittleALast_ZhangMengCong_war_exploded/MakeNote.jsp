...
<form id="formBlog" action="/GetNote" method="post">
    <input id="blog_title" name="title" pattern="[\w]{4,20}" value="" style="display: none;"></input>
    <textarea id="blog_md" name="md" value="" pattern="[\w]{4,9999}" style="display: none;"></textarea>
    <textarea id="blog_html" name="html" value="" pattern="[\w]{4,9999}" style="display: none;"></textarea>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div id="blog_mdedit">
                        ...
                        <textarea style="display:none;" >${requestScope.mynote}
                        </textarea>
                </div>
            </div>
        </div>
