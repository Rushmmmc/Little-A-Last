...
<form action="/Quit?method=quit" method="post" align="center"  >
    <a href="/ChangePage?method=mission"> <h1><font color="red">发布灭天榜</font></h1></a>
    <a href="/ReadNote.jsp"> <h3><font color="#1e90ff">写笔记</font></h3></a>
    <a href="/ChangePage?method=managemember"> <h3><font color="red">管理成员</font></h3></a>
