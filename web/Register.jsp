...
<form   action="/Register"  method="post" align="center"  >
    ...
    <br>
    新密码:<input type="password" name="password" pattern="[\w]{4,10}" required/>
    </br>
    ...
    <br>
    <font color="red"> 注意:用户名 新密码 长度均为4-10 邮箱地址长度为8-20<br> 用户名和密码仅支持数字及字母 </font>
