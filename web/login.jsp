...
<div class="box">
    <h2>小A知识共享平台</h2>
    <form   action="/login?method=login&way=normal" method="post" align="center"  >
        <div class="inputBox">
...
<div id="inline-block">
    ...
    <div>
        <form  method="post" align="center">
            <img id="checkCodeonc" src="/captcha"  /><br>
            <a href="#" onclick="change();">看不清，换一张</a><br/>
        </form>
    </div>

    <form  method="post" align="center">
        <a   href="/login?method=login&way=cookie" ><font color="blue" >使用cookie登录</font></a>
        <a   href="/forget.jsp" ><font color="blue" >忘记密码?</font></a>
        <a   href="/login?method=login&way=normal&username=visitor&password=visitor&captcha=qqqq" ><font color="blue" >以游客登陆</font></a>
        </form>
